    ...
    <div class="max-w-4xl mx-auto space-y-6">
        ...
        <div class="flex items-center gap-4">
            ...
            <div>
                ...
                <p class="text-slate-500 text-sm">Refine your article for the community.</p>
            </div>
        </div>
        ...
        <form action="{{ route('mentor.blogs.update', $post->id) }}" method="POST" enctype="multipart/form-data"
            id="blogForm">
            @csrf
            @method('PUT')
