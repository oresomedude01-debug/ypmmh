    ...
    <div class="max-w-4xl mx-auto space-y-6">
        ...
        <div class="flex items-center gap-4">
            ...
            <div>
                ...
                <p class="text-slate-500 text-sm">Write an engaging article for the community.</p>
            </div>
        </div>
        ...
        <form action="{{ route('mentor.blogs.store') }}" method="POST" enctype="multipart/form-data" id="blogForm">
            @csrf
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div class="glass p-6 rounded-xl space-y-4">
                        ...
                        <div>
                            ...
                            <textarea name="excerpt" id="excerpt" rows="3"
                                placeholder="A brief summary that appears on the blog index..."
                ...
                <div class="space-y-6">
                    <div class="glass p-6 rounded-xl space-y-4">
                        ...
                        <a href="{{ route('mentor.blogs.index') }}" class="btn btn-secondary w-full justify-center">
                            Cancel
                        </a>
                    </div>
                </div>
